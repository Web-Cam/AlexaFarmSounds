...
var sheep = '<audio src="https://s3.amazonaws.com/alexafarmsounds/sheep.mp3"/>';
...
var last = "none";
var tries = 0;
var randomanimal = ['SayCow','SayCat','SaySheep','SayHorse','SayDuck','SayRooster','SayChicken'];
...
var handlers = {
    'LaunchRequest': function () {
        this.emit(':ask',"Welcome to farm sounds........ Say Start to begin");
		last = "none";
    },
...
'SayRooster': function () {
	...
	'Incorrect': function () { // Should make this into a switch this got way carried away.
     if (last === "dog"){
		if (tries <= 2){ // Tries really dont matter just a way to switch it between hints
				tries +=3 
	 ...
	 this.emit(':ask',"Almost there, These animals love to drink Milk");
	 }
	}
